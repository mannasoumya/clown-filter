...
let righteyeX = 0;
let righteyeY = 0;
let c, msg, button2, r_slider, g_slider, b_slider;
function setup() {
...
function draw() {
  ...
  // fill(140,0,140,100);
  fill(r_slider.value(), g_slider.value(), b_slider.value(), 100);
  stroke(255);
